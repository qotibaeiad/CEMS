...
public class Report2ExamLec {
    ...
    @FXML
    private Text average1, medin1, average2, medin2;

    @FXML
    private ComboBox<String> lecId, exam_id1, exam_id2;

    @FXML
    private BarChart<String, Number> graph1, graph2;

    @FXML
    private CategoryAxis xAxis1, xAxis2;
